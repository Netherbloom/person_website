...
import com.util.hunter.FileManager;
import com.util.hunter.ImageHunter;
import com.util.ueditor.define.ActionMap;
import com.util.ueditor.define.AppInfo;
import com.util.ueditor.define.BaseState;
import com.util.ueditor.define.State;
import com.util.ueditor.upload.Uploader;
	...
	public String invoke() throws JSONException {
		...
		switch ( actionCode ) {
			...
			case ActionMap.UPLOAD_FILE:
			  ...
			  if(rootPath.indexOf(Gloab.PROJECT_NAME)>0){
					rootPath=rootPath.replace(Gloab.PROJECT_NAME, Gloab.PROJECT_FILE_NAME);
